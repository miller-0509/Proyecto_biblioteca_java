...
public class FRMPrestamos extends JInternalFrame {
    ...
    public FRMPrestamos() {
        super("Préstamos", true, true, true, true);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        JLabel iconLabel = new JLabel("PR", SwingConstants.CENTER);
        iconLabel.setFont(new Font("SansSerif", Font.BOLD, 48));
        iconLabel.setForeground(SENA_GREEN);
        iconLabel.setAlignmentX(0.5f);

        JLabel titleLabel = new JLabel("Módulo de Préstamos", SwingConstants.CENTER);
        titleLabel.setFont(new Font("SansSerif", Font.BOLD, 26));
        titleLabel.setForeground(TEXT_DARK);
        titleLabel.setAlignmentX(0.5f);

        JLabel descLabel = new JLabel("<html><div style='text-align:center;width:400px;'>Gestión de préstamos de equipos y libros de la biblioteca.</div></html>", SwingConstants.CENTER);
        ...
        stateLabel.setBackground(new Color(242, 170, 55));
