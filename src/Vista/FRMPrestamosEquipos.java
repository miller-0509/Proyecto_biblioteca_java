...
public class FRMPrestamosEquipos extends JInternalFrame {
    ...
    public FRMPrestamosEquipos() {
        super("Gestión de Préstamos de Equipos", true, true, true, true);
    ...
    private void construirVista() {
        setTitle("Gestión de Préstamos de Equipos");
        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
    ...
    private JPanel crearEncabezado() {
        ...
        JLabel subtitulo = new JLabel("Consulta y administra los préstamos de equipos del sistema.");
    ...
    private JPanel crearPanelTabla() {
        ...
        JLabel lblBuscar = new JLabel("BUSCAR PRÉSTAMO");
        ...
        String[] columnas = {"ID", "USUARIO", "EQUIPO", "SOLICITUD", "ESTADO", "DEVOLUCIÓN", "ACCIONES"};
        ...
        tabla.setGridColor(new Color(240, 243, 247));
    ...
    private void abrirFormularioNuevo() {
        FRMNuevoPrestamoEquipo form = new FRMNuevoPrestamoEquipo(
                (javax.swing.JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), this);
    ...
    private class BotonDevolverEditor extends AbstractCellEditor implements TableCellEditor {
        ...
        public BotonDevolverEditor() {
            ...
            btn.addActionListener(e -> {
                ...
                int confirm = JOptionPane.showConfirmDialog(FRMPrestamosEquipos.this,
                        "¿Confirmar devolución?", "Devolver", JOptionPane.YES_NO_OPTION);
                if (confirm == JOptionPane.YES_OPTION) {
                    controlador.devolverEquipo(idPrestamo);
                    cargarDatos();
                }
                fireEditingStopped();
            });
    ...
    private static class FondoInternoPanel extends JPanel {
        ...
        static {
            Image img = null;
            try { img = new ImageIcon(FRMPrestamosEquipos.class.getResource("/imagenes/fondo.jpg")).getImage(); } catch (Exception e) {}
            FONDO = img;
        }
        @Override protected void paintComponent(Graphics g) {
            ...
            if (FONDO != null) {
                ...
                double scale = Math.max((double) w / FONDO.getWidth(null), (double) h / FONDO.getHeight(null));
                int drawW = (int) Math.round(FONDO.getWidth(null) * scale);
                int drawH = (int) Math.round(FONDO.getHeight(null) * scale);
                g2.drawImage(FONDO, (w - drawW) / 2, (h - drawH) / 2, drawW, drawH, null);
            } else {
